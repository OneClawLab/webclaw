...
import {markdownLanguage, mkLang, getCodeParser, headerIndent} from "./markdown.js"
import {insertNewlineContinueMarkup, deleteMarkupBackward} from "./commands.js"
...
export function markdown(config: {
  ...
  /// [`markdownLanguage`](#lang-markdown.markdownLanguage).
  base?: Language,
  ...
  let {codeLanguages,
       defaultCodeLanguage,
       addKeymap = true,
       base: {parser} = markdownLanguage,
       pasteURLAsLink: pasteURL = true} = config
